...
fn main() -> eframe::Result<()> {
    ...
    let old_testament_path = Path::new("/Users/rootuser/pythonproj/Biblapp/biblapp/old_testament");
    let new_testament_path = Path::new("/Users/rootuser/pythonproj/Biblapp/biblapp/new_testament");
